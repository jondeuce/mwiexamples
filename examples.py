...
# os.environ["JULIA_PROJECT"] = "/path/to/julia/project" # optional; custom path to julia project environment
...
z_real = 1e-3 * np.random.randn(*image.shape) # small amount of random noise (real channel)
z_imag = 1e-3 * np.random.randn(*image.shape) # small amount of random noise (imaginary channel)
