...
# NOTE:
#   Must call from within mwiexample/ folder, as the settings files
#   contain relative paths to the example data.
...
julia examples.jl @data/example1/settings.txt
...
export JULIA_NUM_THREADS=4
julia examples.jl @data/example2/settings.txt
